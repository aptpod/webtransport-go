...
const logEnv = "WEB_TRANSPORT_GO_LOG_LEVEL"
...
func init() {
	...
	DefaultLogger.WithPrefix("webtransport-go").SetLogLevel(readLoggingEnv())
}
...
func readLoggingEnv() LogLevel {
	...
	default:
		fmt.Fprintln(os.Stderr, "invalid webtransport-go log level")
		return LogLevelNothing
	}
}
